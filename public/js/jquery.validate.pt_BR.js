...
$.extend($.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format("{0} caracteres no máximo.."),
		minlength: $.validator.format("{0} caracteres no mínimo."),
		rangelength: $.validator.format("Entre {0} e {1} caracteres."),
		range: $.validator.format("Entre {0} e {1} caracteres."),
		max: $.validator.format("{0} caracteres no máximo."),
		min: $.validator.format("{0} caracteres no mínimo.")
	},
