<?php 
class Representantes extends My_Db_Table_Abstract
{
	protected $_name='representantes';
	 ...
	 protected $_validate = array(
			...
			'nome'=>array(
				...
				'Db_NoRecordExists'	=> array(
					'options'=>array('representantes','nome'),
			...
			'nome_empresa'=>array(
				'Db_NoRecordExists'	=> array(
					'options'=>array('representantes','nome_empresa'),
			...
			'cnpj'=>array(
				...
				'Db_NoRecordExists'	=> array(
					'options'=>array('representantes','cnpj'),
